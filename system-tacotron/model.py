...
class Tacotron2(nn.Module):
    ...
    def parse_batch(self, batch):
        text_padded, input_lengths, mel_padded, gate_padded, \
            output_lengths, emotions, speakers = batch
    ...
    def forward(self, inputs, emotion_embedding):
        text_inputs, text_lengths, mels, max_len, output_lengths, emotions, speakers = inputs
        text_lengths, output_lengths = text_lengths.data, output_lengths.data

        embedded_inputs = self.embedding(text_inputs).transpose(1, 2)
        emotion_embedding = self.emotion_embedding(emotion_embedding)
        encoder_outputs = self.encoder(embedded_inputs, text_lengths)
        encoder_outputs = encoder_outputs + emotion_embedding
    ...
    def inference(self, inputs, speaker_id):
        ...
        return outputs, embedded_speakers
